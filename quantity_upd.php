...
if(!isset($_SESSION['user_session'])){
    ...
    $update_sql = "UPDATE stock SET used_quantity = (used_quantity - '$hid_qty') + '$upd_qty' , remain_quantity = (remain_quantity + '$hid_qty')-'$upd_qty'  where medicine_name = '$med_name' and category = '$med_cat' and Rack = '$Rack' and expire_date = '$ex_date' ";

    $result = mysqli_query($con,$update_sql);

    $update_sql1 = "UPDATE cart SET qty = '$upd_qty' , amount = '$amount' , profit_amount = '$profit_amount' where id = '$med_id'";

   $result2 = mysqli_query($con,$update_sql1);  


   $select_sql1= "SELECT remain_quantity from stock where medicine_name = '$med_name' and category = '$med_cat' and Rack = '$Rack' and expire_date = '$ex_date' ";
