...
$select_query= mysqli_query($con,$select_sql);
	...
	$amount = $qty*$cost;
	$profit_amt = $profit_amount*$qty;

               $insert_sql ="INSERT INTO cart values('','$invoice_number','$medicine_name','$category','$expire_date','$qty','$sell_type','$cost','$amount','$profit_amt','$date')";//*****INSERTING INTO on_HOLD TABLE*******
