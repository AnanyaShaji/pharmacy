  ...
  <div class="navbar navbar-inverse navbar-fixed-top"><!--***HEADER****---->
    ...
    <div class="row">
      <div class="col-12">
        <form method="POST">
          ...
          <table id="table0" class="table table-bordered table-striped table-hover">
           <thead>
            ...
            <th width="3%">Rack</th>
             <!--<th width="1%">Batch No</th>-->
             <th width="5%">Registred Qty</th>
        ...
        <?php $sql = "SELECT  id,bar_code, medicine_name, category, Rack, quantity,used_quantity, remain_quantity,act_remain_quantity, register_date, expire_date, company, sell_type , actual_price, selling_price, profit_price, status FROM stock order by id desc"; ?>
