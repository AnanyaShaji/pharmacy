...
<body>
 	 	<form method="POST" action="register.php?invoice_number=<?php echo $_GET['invoice_number']?>">
  	  	 ...
  	  	 <tr>
         <td>Bar Code:</td>
         <td><input type="text" name="bar_code" id="bar_code" size="4" minlength="4" pattern="^(?:(?!^(2779|2269|2777|1906|1779|2022|2220|1169|1020|1003|1001|1121|1112)$).)*$" title="Barcode must be unique" required placeholder="Set a bar code"></td>
          </tr>
          <tr id="row1">
         <td>Medicine Name:</td>
...
<td><input type="text" name="Rack" id="Rack" size="10"  required></td>
</tr>
