...
<style>
        body {
            ...
            background-image: url(''); /* Adjust the path to your image */
 ...
 <div class="navbar navbar-inverse navbar-fixed-top"><!--*****Header******-->
      ...
      <div class=" navbar-inner">
        ...
        <span class="icon-bar"></span>
          ...
          <a class="brand" href="#"><b>MedShop</b></a>
 ...
 <div class="container">
        ...
        <font>Today's Sales:</font>
                ...
                <div>
                    ...
                    <strong>
                        ...
                        <?php
                            $Today = date('Y-m-d');  // Using 'Y-m-d' format to match the typical date format.
   ...
   <div class="container">
    ...
    <center>
     ...
     <input type="text" id="product" required  autocomplete="off" placeholder="Medicine" style="width:350px;height: 30px;">
        ...
        <tr style="background-color: #383838; color: #FFFFFF;" >
            ...
            $quantity= "";
                ...
                <tr class="record">
                     ...
                     <?php
                        ...
                        echo "<a href='#' class='qty_upd$i'></span></a>";
           ...
           <td><a href="delete_invoice.php?invoice_number=<?php echo $_GET['invoice_number']?>&id=<?php echo $row['id'];?>&name=<?php echo $row['medicine_name']?>&expire_date=<?php echo $row['expire_date']?>&quantity=<?php echo $row['qty'];?>" class="btn btn-danger">Remove</a></td>
              ...
              <td  colspan="2"><strong>
                ...
                $select_sql = "SELECT sum(amount) , sum(profit_amount) from cart where invoice_number = '$invoice_number'";
